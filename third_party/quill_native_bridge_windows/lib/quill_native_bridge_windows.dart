...
class QuillNativeBridgeWindows extends QuillNativeBridgePlatform {
  ...
  Future<void> copyHtmlToClipboard(String html) async {
    ...
    try {
      ...
      // PATCH: win32 >=5.5 exposes GMEM_MOVEABLE only via the GLOBAL_ALLOC_FLAGS
      // extension type, not as a top-level constant. Upstream 0.0.2 references the
      // bare identifier, which fails to compile on Windows. See flutter-quill #2612.
